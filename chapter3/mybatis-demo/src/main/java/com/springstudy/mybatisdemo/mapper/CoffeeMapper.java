...
public interface CoffeeMapper {
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=com.springstudy.mybatisdemo.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("com.springstudy.mybatisdemo.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set NAME = #{name,jdbcType=VARCHAR},",
          "PRICE = #{price,jdbcType=BIGINT,typeHandler=com.springstudy.mybatisdemo.handler.MoneyTypeHandler},",
